...
const Skills = () => {
  return (
    <>
      ...
      <div className='w-full h-screen relative flex items-center justify-center rounded-full bg-circularLight lg:!h-[75vh] md:!h-[60vh] sm:!h-[55vh] xs:!h-[50vh] lg:!bg-circularLightLg md:!bg-circularLightMd sm:!bg-circularLightSm
      '>
